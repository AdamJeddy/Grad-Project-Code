...
## Saved Models
The `Saved Models` folder contains the h5 files of the trained cv models. These models have been trained with data from multiple people and on different words with a large number of videos.
